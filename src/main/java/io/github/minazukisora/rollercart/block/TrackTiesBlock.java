...
public class TrackTiesBlock extends FacingBlock implements BlockEntityProvider {
    ...
    public void neighborUpdate(BlockState state, World world, BlockPos pos, Block sourceBlock, BlockPos sourcePos, boolean notify) {
        ...
        if (world.getBlockEntity(pos) instanceof TrackTiesBlockEntity tie) tie.updatePower();
    }

    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (player.canModifyBlocks() &&
                !player.getStackInHand(hand).isIn(RollerCart.TRACK_TAG) &&
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
       if(type == RollerCart.TRACK_TIES_BE.get()) {
